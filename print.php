<?php 
  ...
  $sql="select * from invoice_product where SID='{$_GET["id"]}'";
  $res=$con->query($sql);
  if($res->num_rows>0){
  ...
  class PDF extends FPDF
  {
    function Header(){
      ...
      $this->Cell(50,10,"MURALICOMPUTERS",0,1);
      $this->SetFont('Arial','',14);
      $this->Cell(50,7,"West Street,",0,1);
      $this->Cell(50,7,"tiruppur 641605.",0,1);
      $this->Cell(50,7,"PH : 9751774820",0,1);
    ...
    function Footer(){
      ...
      $this->SetY(-50);
      $this->SetFont('Arial','B',12);
      $this->Cell(0,10,"for MURALICOMPUTERS",0,1,"R");
      $this->Ln(15);
      $this->SetFont('Arial','',12);
